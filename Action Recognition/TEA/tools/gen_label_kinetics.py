...
dataset_path = '/media/cj1/data/kinetics-400-fps/image'
label_path = '/home/cj1/tea-action-recognition/tools/kinetics400'
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            if not os.path.exists(img_dir):
                ...
                output.append('%s %d %d'%(img_dir,len(dir_files),curIDX))
