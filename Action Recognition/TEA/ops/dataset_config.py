...
def return_something(modality):
    filename_categories = 174
    if modality == 'RGB':
        filename_imglist_train = '/home/cj1/tea-action-recognition/' \
                'tools/somethingv1/train_videofolder.txt'
        filename_imglist_val = '/home/cj1/tea-action-recognition/' \
                'tools/somethingv1/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    else:
        print('no such modality:'+modality)
        raise NotImplementedError
...
def return_kinetics(modality):
    filename_categories = 400
    if modality == 'RGB':
        filename_imglist_train = '/home/cj1/tea-action-recognition/tools/kinetics400/train_videofolder.txt'
        filename_imglist_val = '/home/cj1/tea-action-recognition/tools/kinetics400/val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, prefix
