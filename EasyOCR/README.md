# OCR
This is an excellent text recognition project that can recognize many languages. If you are interested, you can visit the official code base - [EasyOCR](https://github.com/JaidedAI/EasyOCR).
