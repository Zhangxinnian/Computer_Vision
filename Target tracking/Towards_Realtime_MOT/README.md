# Target Tracking
This is a very good multi-target tracking project. If you are interested, you can visit the original [code](https://github.com/Zhongdao/Towards-Realtime-MOT) .
