# OCR
This is a very good project, suitable for scene text recognition (STR). 
It has won the first place in the ICDAR2019 competition. 
This algorithm is still a traditional two-stage. The recognition part is worth learning from, but it also faces a problem that is not as good as end-to-end. That kind of detection and recognition can call back error information. The detection part uses Cascade mask rcnn. If you are interested, you can try to train detection and recognition by yourself.
[AttentionOCR](https://arxiv.org/abs/1912.04561).
[__arXiv technical report__](https://arxiv.org/abs/1912.04561).
