...
#include "nanodet.h"
#include "include/ncnn/benchmark.h"
...
int image_demo(NanoDet &detector, const char* imagepath)
{
    ...
    for (auto img_name : filenames)
    {
        ...
        auto results = detector.detect(resized_img, 0.25f, 0.45f);
...
int main(int argc, char** argv)
{
    ...
    NanoDet detector = NanoDet("/home/cj1/CLionProjects/nanodet/weights/nanodet_m.param", "/home/cj1/CLionProjects/nanodet/weights/nanodet_m.bin", true);
