# Target Detection
Here, yolov5 is used for detection, if necessary, please visit the official code base.
[Yolov5](https://github.com/ultralytics/yolov5)    
The face recognition part and multi-target tracking part of this library contain examples based on yolov5, so stay tuned.
# Below is the original README of Yolov5
